...
export default () => {
  ...
  const cards = [
    {
      ...
      locationText: "Bishkek, Kyrgyzstan",
      pricingText: "сом 1499/сутки",
      rating: "4.8",
    },
    {
      ...
      title: "Orion Paradise",
      description: "Lorem ipsum dolor sit amet, consectur dolori adipiscing elit, sed do eiusmod tempor nova incididunt ut labore et dolore magna aliqua.",
      locationText: "Bishkek, Kyrgyzstan",
      pricingText: "сом 999/сутки",
      rating: 4.9,
    },
    {
  ...
  return (
    <Container>
      <Content>
        <HeadingWithControl>
          <Heading>Популярные Места</Heading>
          <Controls>

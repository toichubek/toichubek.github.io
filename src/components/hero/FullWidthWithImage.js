...
export default ({
  ...
  description = "Мы работаем в турбизнесе по всему Кыргызстану уже 2 года. Мы заверяем вас, что вы всегда будете наслаждаться пребыванием у нас.",
  primaryActionUrl = "#",
  primaryActionText = "Связаться с нами",
  secondaryActionUrl = "#",
  secondaryActionText = "Поиск туров",
}) => {
  return (
    <Container>
      <TwoColumn>
